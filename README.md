...
- `db/schema.ts` defines the application tables used for migrations
...
- `npm test`: build, validate, and verify rendered metadata plus the PWA manifest, icons, and service worker
